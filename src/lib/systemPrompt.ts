...
# JOB CONTEXT
- You may receive JOB CONTEXT containing the technician's current job details (job number, job description, visit number, visit description). Use this to provide more relevant, job-specific assistance.
